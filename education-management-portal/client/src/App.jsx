// App.jsx — Main Routing with Role-Based ProtectedRoute guards
      ...
      <FeedbackProvider>
        <Router>
          <Routes>
            ...
            <Route path="/student/courses"    element={<ProtectedRoute allowedRoles={['student']}><StudentLayout><MyCourses /></StudentLayout></ProtectedRoute>} />
            <Route path="/student/assignments"element={<ProtectedRoute allowedRoles={['student']}><StudentLayout><Assignments /></StudentLayout></ProtectedRoute>} />
            <Route path="/student/attendance" element={<ProtectedRoute allowedRoles={['student']}><StudentLayout><Attendance /></StudentLayout></ProtectedRoute>} />
            <Route path="/student/grades"     element={<ProtectedRoute allowedRoles={['student']}><StudentLayout><Grades /></StudentLayout></ProtectedRoute>} />
            <Route path="/student/progress"   element={<ProtectedRoute allowedRoles={['student']}><StudentLayout><Progress /></StudentLayout></ProtectedRoute>} />
